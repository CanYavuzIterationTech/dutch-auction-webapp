...
export interface DutchAuctionLaunchpadReadOnlyInterface {
  ...
  auction: ({ auctionId }: { auctionId: number }) => Promise<Auction>;
  params: () => Promise<Params>;
}
export class DutchAuctionLaunchpadQueryClient
  implements DutchAuctionLaunchpadReadOnlyInterface
{
  ...
  auction = async ({ auctionId }: { auctionId: number }): Promise<Auction> => {
    return this.client.queryContractSmart(this.contractAddress, {
      auction: {
...
export interface DutchAuctionLaunchpadInterface
  extends DutchAuctionLaunchpadReadOnlyInterface {
  contractAddress: string;
  sender: string;
  createAuction: (
    {
...
export class DutchAuctionLaunchpadClient
  extends DutchAuctionLaunchpadQueryClient
  implements DutchAuctionLaunchpadInterface
{
